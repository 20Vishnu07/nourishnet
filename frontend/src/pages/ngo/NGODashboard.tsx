...
const styles = {
  ...
  detail: { background: "#f5f5ff", borderRadius: "12px", padding: "1.5rem", marginTop: "1rem", border: "2px solid #667eea" },
  claimBtn: { padding: "0.6rem 1.5rem", borderRadius: "8px", border: "none", background: "#667eea", color: "white", fontSize: "0.9rem", fontWeight: 600, cursor: "pointer", marginRight: "0.5rem" },
  closeBtn: { padding: "0.6rem 1.5rem", borderRadius: "8px", border: "1px solid #ddd", background: "white", cursor: "pointer", fontSize: "0.9rem" },
  list: { display: "flex", flexDirection: "column" as const, gap: "0.5rem" },
  card: { background: "#f9f9f9", borderRadius: "8px", padding: "0.75rem 1rem", cursor: "pointer", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap" as const, gap: "0.5rem" },
  qty: { color: "#667eea", fontWeight: 600, fontSize: "0.9rem" },
  expiry: { color: "#999", fontSize: "0.8rem" },
};
